...
class ImgSegmentSimple : public Manip{
    ...
    public:
         ...
         *
         */
        bool set_dim(remote_robotics::rect_dims::Request& req, remote_robotics::rect_dims::Response& res);
};
...
class ImgSegmentSpecial : public IManip{
    ...
    public:
         ...
         *
         */
        bool set_dim_by_index(remote_robotics::motor_idx::Request& req, remote_robotics::motor_idx::Response& res);
};
